...
public class XbmcV12SmartPlaylist implements FormattedSmartPlaylist, XbmcSmartPlaylist {
    private String type;
    private String name;
    ...
    public String toString() {
        ...
        try {
            context = JAXBContext.newInstance(XbmcV12SmartPlaylist.class);
    ...
    public static class Rule implements XbmcSmartPlaylist.Rule {
        ...
        @Override
        public String toString() {
            return String.format("<rule field=\"%s\" operator=\"%s\"><value>%s</value></rule>", field, operator, operand);
        }
    }
}
